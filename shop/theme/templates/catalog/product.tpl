          ...
          <div class="col-md-7">
            {block name='page_header_container'}
              {block name='page_header'}
                {assign product_name explode(" -", $product.name)}
                <h1 class="h1 namne_details">{$product_name[0]}</h1>
                {if $product_name|count > 1}
                  <h3 class="h3 namne_details">-{$product_name[1]}</h3>
                {/if}
                {if isset($product.reference_to_display) && $product.reference_to_display neq ''}
                  <p>{l s='Reference' d='Shop.Theme.Catalog'}: {$product.reference_to_display}</p>
                {/if}
              {/block}
            {/block}
