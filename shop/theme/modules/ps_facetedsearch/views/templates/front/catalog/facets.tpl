...
{if $displayedFacets|count}
  <div id="search_filters">
    {block name='facets_title'}
      <div class="title_block">{l s='Filter By' d='Shop.Theme.Actions'}</div>
    {/block}
      ...
      {if $activeFilters|count}
        <div class="selectedFilters clearfix">
          <button data-search-url="{$clear_all_link}" class="btn btn-tertiary js-search-filters-clear-all">
            <span class="txt">{l s='Clear all' d='Shop.Theme.Actions'}</span>
    ...
    {foreach from=$displayedFacets item="facet"}
      <section class="facet af_filter clearfix" data-type="{$facet.type}">
        <div class="af_subtitle hidden-sm-down">{$facet.label}</div>
